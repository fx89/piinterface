...
export class DataService {
  ...
  public PinCalendarActionsRepository : CRUDLoadingModalWrappedHttpRepository;
  public PinCalendarEntriesRepository : CRUDLoadingModalWrappedHttpRepository;
  ...
  constructor(
    ...
    this.PinCalendarActionsRepository = new CRUDLoadingModalWrappedHttpRepository(loadingModalService, toastService, client, backendURL, "pinCalendarActions", "Calendar action"   , "Calendar actions"   , ""                                     , ""            );
    this.PinCalendarEntriesRepository = new CRUDLoadingModalWrappedHttpRepository(loadingModalService, toastService, client, backendURL, "pinCalendarEntries", "Calendar entry"    , "Calendar entries"   , ""                                     , ""            );
  }
}
